...
<head>
    ...
    <link rel="stylesheet" href="treasure hub seller page.css">
...
<?php endif; ?>
    ...
    <section class = "mobileBackground" id ="mobileBackground">
        ...
        <div class = "mobileSellerNameContainer">
            <p><?php echo htmlspecialchars($disp_sellername)?></p>
        </div>
        <div class="mobileSellerDescriptionContainer">
            <p><?php echo htmlspecialchars($disp_Description)?></p>
        </div>
        <!--
        <div class="mobileSellerRating-Container">
            <p>Rating Placeholder</p>
        </div>
        
        <div class="mobileContactButton-Container">
        ...
        <div class = "PlaceholderSliderContainer" id="SellerForSaleSection">
            ...
            <div class = "PlaceholderSliderContainer-contentSection">
                <?php
                 $productQuery = mysqli_query($conn, "SELECT * FROM product WHERE isSold = 0 AND SellerID = $sellerId");
                ...
                ?>
                <div class="PlaceholderSliderItemPlaceholder" onclick="ShowProduct('<?php echo $productId ?>')">
            ...
            }else echo '<p class = "noResultsText"> No items listed yet :) </p>';
            ?>
        ...
        <div class = "PlaceholderSliderContainer" id="SellerSoldSection">
            ...
            <div class = "PlaceholderSliderContainer-contentSection">
                <?php
                 $productQuery = mysqli_query($conn, "SELECT * FROM product WHERE isSold = 1 AND SellerID = $sellerId");
                if ($productQuery && mysqli_num_rows($productQuery) > 0) {
                while ($row = mysqli_fetch_assoc($productQuery)) {
                    $placeholderPicPath = "placeholder logo.png"; // Default fallback
                    $altText = "Product Image";
    ...
    <section class = "desktopBackground" id = "desktopBackground">
        ...
        <div class="Sellerbanner-container">
            ...
            <img src="<?php echo $sellerProfilePic?>" alt="seller profile picture in circle" class="circle-image">
        </div>
    ...
    -->
            <div class = "mainDetailsContainers-textContainer">
                ...
                <div class = sellerDescriptionConatiner>
                    <p><?php echo htmlspecialchars($disp_Description)?></p><br>
                </div>
        ...
        <table>
            ...
            <tr>
              <td>First Name</td>
              <td style="font-weight: 600;"><?php echo htmlspecialchars($seller['FirstName'])?></td>
            </tr>
            <tr>
              <td>Last Name</td>
              <td><?php echo htmlspecialchars($seller['LastName'])?></td>
            </tr>
            <tr>
              <td>dateJoined</td>
              <td><?php echo htmlspecialchars($seller['dateJoined'])?></td>
            </tr>
            <tr>
              <td>Verified</td>
              <td><?php if($seller['Verified'] == 0)
                    {
...
<script>
    ...
    {
        window.location.href = "reportUserPage.php?seller="+seller;
    }
