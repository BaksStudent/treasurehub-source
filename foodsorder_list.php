...
$orderQuery = mysqli_query($conn, "SELECT * FROM foodorders WHERE UserID = '$userID' ORDER BY OrderDate DESC");
?>
...
<?php while ($order = mysqli_fetch_assoc($orderQuery)): ?>
    ...
    if ($item = mysqli_fetch_assoc($itemQuery)) {
        ...
        $imageQuery = mysqli_query($conn, "SELECT * FROM foodproduct WHERE ProductID = '$productID'");
    ...
    function MainCall()
  {
    ...
    function OpenSummary(orderID)
    {
        ...
        body: 'orderId=' + encodeURIComponent(orderID)
            ...
            window.location.href = "foodsOrder-Summary.php";
            })
            .catch(error => {
